...
public enum TroopInsignia
{
    ...
    /// A single wild will guarantee a three card set within five cards. see <see cref="TroopCardSet.IsValidTrade(Shared.Interfaces.Model.ICard{Shared.Geography.Enums.TerrID}[])"/>.
    /// </remarks>
    Wild = 0,
    /// <summary>
