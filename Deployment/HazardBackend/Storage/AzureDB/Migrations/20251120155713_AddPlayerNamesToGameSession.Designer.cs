...
namespace HazardBackend.Migrations
{
    ...
    [Migration("20251120155713_AddPlayerNamesToGameSession")]
    partial class AddPlayerNamesToGameSession
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HazardBackend.Entities.AttackActionEntity", b =>
                {
            ...
            modelBuilder.Entity("HazardBackend.Entities.GameSessionEntity", b =>
                {
                    b.Property<Guid>("GameId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HazardBackend.Entities.MoveActionEntity", b =>
                {
                    b.Property<Guid>("GameId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HazardBackend.Entities.PlayerStatsEntity", b =>
                {
            ...
            modelBuilder.Entity("HazardBackend.Entities.TradeActionEntity", b =>
                {
                    b.Property<Guid>("GameId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HazardBackend.Entities.AttackActionEntity", b =>
                {
                    b.HasOne("HazardBackend.Entities.GameSessionEntity", "GameSession")
                        .WithMany("AttackActions")
                        .HasForeignKey("GameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HazardBackend.Entities.PlayerStatsEntity", null)
                        .WithMany()
