...
{
    /// <summary>
    /// Notifies <see cref="Share.Interfaces.ViewModel.IMainVM"/> that a territory's owner or armies have changed.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// Notifies <see cref="Share.Interfaces.ViewModel.IMainVM"/> that a continent's owner has changed.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// Defines relations between and among Territories and Continents that represent Board geography.
    /// </summary>
    IGeography Geography { get; }
    /// <summary>
    ...
    /// </summary>
    /// <param name="playerNumber">The <see cref="IPlayer.Number"/> of the specified player.</param>
    ...
    /// <summary>
    /// Updates the <see cref="IBoard"/> state when a player claims a territory for the first time.
    /// </summary>
    /// <remarks>
    /// This change should also fire <see cref="TerritoryChanged"/> and subsequent events.
    /// </remarks>
    /// <param name="newPlayer">The <see cref="IPlayer.Number"/> of the <see cref="IPlayer"/> that takes the territory.<paramref name="newPlayer"/></param>
    ...
    /// </summary>
    /// <param name="source">The <see cref="TerrID"/> of the territory from which the attack originated.</param>
    /// <param name="target">The <see cref="TerrID"/> of the territory that was attacked and is being conquered.</param>
    ...
    /// <param name="changed">The <see cref="TerrID"/> of the territory that changed hands.</param>
