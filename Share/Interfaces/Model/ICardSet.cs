...
/// (1) By <see cref="Model.DataAccess.Cards.ICardSetDataJConverter"/>. See also <see cref="ICardSetData"/> and <see cref="IDataProvider"/>.
/// (2) By <see cref="Model.DataAccess.AssetFactory.BuildTroopCards(ICardSet)"/>.
/// </remarks>
public interface ICardSet
{
    ...
    /// <br/> E.g. "TroopCard", see <see cref="Model.Entities.Cards.TroopCard"/>.
    /// </summary>
    /// <remarks>
