...
public interface ITroopsAdvanceEventArgs
{
    ...
    /// </summary>
    /// <value>
    /// <see langword="true"/> if the advance is ocurring after a successful attack; <see langword="false"/> if the advance is a move during <see cref="Hazard_Share.Enums.GamePhase.Move"/>.
    /// </value>
    ...
    int Min { get; init; }
    /// <summary>
    /// Gets or inits the <see cref="int"/> value of the source territory's <see cref="Hazard_Share.Enums.TerrID"/>.
    /// </summary>
    /// <value>
    /// An <see cref="int"/>.
    /// </value>
    int Source { get; init; }
    /// <summary>
    /// Gets or inits the <see cref="int"/> value of the target territory's <see cref="Hazard_Share.Enums.TerrID"/>.
    /// </summary>
    /// <value>
    /// An <see cref="int"/>.
    /// </value>
