...
/// <example>E.g. <code>int territoryArmies = <see cref="Hazard_Model.Entities.EarthBoard"/>[<see cref="TerrID"/>];</code>
/// gets the armies on the territory identified by <see cref="TerrID"/> while <code><see langword="for"/> (<see langword="int"/> i = 0; i &lt; 41; i++) { <see cref="Hazard_Model.Entities.EarthBoard.Armies"/>
