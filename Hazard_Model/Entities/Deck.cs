...
public class Deck
{
    ...
    /// </remarks>
    /// <value>
    /// A <see cref="List{T}"/> of <see cref="ICard"/> if this <see cref="Deck"/> is initialized; otherwise, <see langword="null"/>.
    /// </value>
    public List<ICard>? Library { get; set; } = null;
    /// <summary>
    ...
    /// A <see cref="List{T}"/> of <see cref="ICard"/> if this <see cref="Deck"/> is initialized; otherwise, <see langword="null"/>.
    /// </value>
    public List<ICard>? DiscardPile { get; set; } = null;
    /// <summary>
    ...
    /// <exception cref="ArgumentNullException">Thrown if <see cref="Library"/> is <see langword="null"/>.</exception>
    ...
    /// <exception cref="NullReferenceException">Thrown if <see cref="DiscardPile"/> is <see langword="null"/>.</exception>
    public void Discard(ICard card)
    {
        if (DiscardPile == null) throw new NullReferenceException(nameof(DiscardPile));
    ...
    /// </remarks>
    /// <exception cref="ArgumentNullException">Thrown if either <see cref="Library"/> or <see cref="DiscardPile"/> are null"/>.</exception>
    public void Shuffle()
    {
        if (Library == null) throw new ArgumentNullException(nameof(Library));
