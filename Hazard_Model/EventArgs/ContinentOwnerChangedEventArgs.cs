...
/// <summary>
/// Packages identification data for the <c>ContinentOwnerChanged</c> event and its handlers. See <see cref="Hazard_Model.Entities.EarthBoard"/>.
/// </summary>
public class ContinentOwnerChangedEventArgs : System.EventArgs, IContinentOwnerChangedEventArgs
{
    ...
    /// </summary>
    /// <param name="changed">The ID of the Continent that has changed.</param>
    /// <param name="oldPlayer">The number of the Player that owned the Continent prior to the change. "None" is represented by -1: see constructor of <see cref="Hazard_Model.Entities.EarthBoard"/></param>.
